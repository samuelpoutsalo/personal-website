          ...
          <div className="about-container">
            ...
            <div className="text-side">
              ...
              <p className="light">
                ...
                Information Techonolgy. Throughout my academic journey, I've
                acquired a solid foundation in various progamming languages,
                both in Front-end and Back-end development. However recently
                I've been focusing on improving my Front-end development skills
                and especially React.
                <br />
              ...
              <div className="site-preview">
                ...
                <div className="text-preview">
                  <h3 className="black">
                    ...
                    <span className="date">(TBD 2023)</span>
                  </h3>
                  <p className="light">
