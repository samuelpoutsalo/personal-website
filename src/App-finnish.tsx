...
function App_finnish() {
  ...
  const [showMore, setShowMore] = useState<String>("Näytä lisää..");
  ...
  const notReady = () => {
    window.alert("Tämä projekti ei ole vielä valmis");
  };
          ...
          <div className="home-container">
            <div className="home-text">
              <div className="focused-text">
                <h1>
                  Front-end keskittynyt ohjelmoija
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                ...
                <p className="light">
                  Moikka! Olen Samuel Poutsalo, motivoitunut ohjelmoija
                  helsingistä, tällä hetkellä keskittyen Java ohjelmointiin.
                </p>
        ...
        <section className="about" id="about">
          <div className="about-container">
            ...
            <div className="text-side">
              <h3>VÄHÄN MINUSTA</h3>
              <h2>Innokas juniorikehittäjä, joka etsii työmahdollisuutta</h2>
              <p className="light">
                ...
                Ennen olin keskittynyt pääosin front-end ohjelmointiin,
                parantaen JavaScript/TypeScript, React ja SCSS taitojani.
                Viimeaikoina olen kuitenkin siirtänyt painopistettäni takaisin
                Javan ja full-stack-kehityksen suuntaan.
                <br />
            ...
            <div className="projects-content">
              <div className="site-preview">
                <div className="text-preview normal flip-text">
                  <h3 className="black">
                    (Suunnitteilla) Java projekti
                    <span className="date"> (TBD 23-24)</span>
                  </h3>
                  <p className="light">
                    Suunnitteillu-/oppisvaiheessa oleva nettisivu jonka avulla
                    pystyn näyttäämään osaamiseni Javan, Spring Bootin ja Spring
                    Frameworking kanssa.
                  </p>
              ...
              <div className="site-preview">
                ...
                <div className="text-preview">
                  <h3 className="black">
                    API nettisivu
                    <span className="date"> (Marraskuu 2023)</span>
                  </h3>
                  <p className="light">
