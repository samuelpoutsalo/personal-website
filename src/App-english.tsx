...
function App_english() {
  ...
  const notReady = () => {
    window.alert("This project is not yet ready");
  };
  ...
  return (
    <div className="App">
      <header className="nav">
        <div className="flags">
          <Link to="/">
            <img id="uk" src={united} className="selectedFlag" />
          </Link>
          <Link to="/fi">
          ...
          <div className="home-container">
            <div className="home-text">
              <div className="focused-text">
                ...
                <p className="light">
                  Hi! I'm Samuel Poutsalo. A motivated developer with a wide
                  range of skills currently focusing Java development. Based in
                  Helsinki, Finland.
                </p>
            ...
            <div className="user-skills">
              <div className="user-text">
                <h3 className="black">Tech Stack - Most skilled in:</h3>
                <p
                  className="light"
                  id="techId"
              ...
              >
                <h3 className="black">Basic knowledge:</h3>
                <img src={java_png} />
                <img src={python_png} />
        ...
        <section className="about" id="about">
          <div className="about-container">
            ...
            <div className="text-side">
              <h3>ABOUT ME</h3>
              <h2>Enthusiastic Junior Developer looking to work</h2>
              <p className="light">
                I'm an enthusiastic 23 year old Finnish student currently in the
                final stages of completing my Bachelor's degree in Business
                Information Techonolgy. During my studies, I have gained a
                strong proficiency in various programming languages, both in
                front-end and back-end roles. Previously I have been primarily
                focusing on front-end development, improving my
                JavaScript/TypeScript, React, and SCSS skills but lately I've
                shifted my focus to Java and full-stack development.
                <br />
                <br /> I am currently actively pursuing atleast a 5-month
                practical training opportunity to finish my degree but would
                love to continue working as a full time developer even after
                finishing my degree.
              </p>
            </div>
          </div>
        ...
        <section className="projects" id="projects">
          <div className="projects-container">
            ...
            <h2 className="projects-head">
              Each site was made specifically for this porfolio to demonstrate
              my skills
            </h2>
            <div className="projects-content">
              <div className="site-preview">
                <div className="text-preview normal flip-text">
                  <h3 className="black">
                    (In Planning) Java project
                    <span className="date"> (TBD 23-24)</span>
                  </h3>
                  <p className="light">
                    A website in the planning/learning phase which I will use to
                    showcase my proficiency with Java, Spring Boot and Spring
                    Framework.
                  </p>
                  <div className="used-code">
                    <p id="id1">Java</p>
                    <p id="id2">S.. Boot</p>
                    <p id="id3">S.. Framework</p>
                  </div>
              ...
              <div className="site-preview">
                <div className="image-preview normal">
                  <a href="https://samuelpoutsalo.github.io/api-countries/">
                    <img src={api} />
                  </a>
                </div>
                <div className="text-preview">
                  <h3 className="black">
                    API website with dark mode
                    <span className="date"> (November 2023)</span>
                  </h3>
                  <p className="light">
                    A simple but responsive website where the user is be able
                    to: Search for all countries from the API on the homepage,
                    Filter countries by region, Click on a countries for more
                    detailed information and Toggle the color scheme between
                    light and dark mode.
                  </p>
                  <div className="used-code">
                    <p>React</p>
                  ...
                  <div className="code-links">
                    <a href="https://github.com/samuelpoutsalo/api-countries">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
              ...
              <div className="site-preview">
                <div className="text-preview normal flip-text">
                  <h3 className="black">
                    Multi-step form <span className="date">(October 2023)</span>
                  </h3>
                  <p className="light">
              ...
              <div className="site-preview">
                ...
                <div className="text-preview">
                  ...
                  <p className="light">
                    A website launch countdown timer with custom CSS animations.
                    Created with React and regular JavaScript
                  </p>
                  <div className="used-code">
                    <p>React</p>
                    <p>CSS</p>
