          ...
          <div className="home-container">
            <div className="home-text">
              <div className="focused-text">
                <h1>
                  Front-End focused React Developer
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                ...
                <p className="light">
                  Hi! I'm Samuel Poutsalo. A motivated developer currently
                  focusing on Front-End and React Development. Based in
                  Helsinki, Finland.
                </p>
          ...
          <div className="about-container">
            ...
            <div className="text-side">
              ...
              <p className="light">
                ...
                front-end and back-end roles. Lately, I have primarily focused
                on front-end development, improving my JavaScript/TypeScript,
                React, and SCSS skills."
                <br />
                <br /> I am currently actively pursuing atleast a 5-month
                practical training opportunity in Front-end development to
                finish my degree but would love to continue working as a full
                time developer even after finishing my degree.
              </p>
            </div>
          </div>
        </section>
